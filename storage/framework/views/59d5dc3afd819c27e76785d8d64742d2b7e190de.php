        ...
        <div class="modal-content">
            <div class="modal-header" style="background-color:#b5b5bf">
                <div class="col-md-4 offset-1">
                    <img src="<?php echo e(asset('img/assignent.png')); ?>" style=" border-radius: 50%;;background-color: #e06363" class="max-h-70px" alt="" />
                </div>
...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/js/bootstrap.min.js"></script>
 <script>
         ...
         $(document).on('click','#save-instruction',function(){
             const url = "<?php echo e(route('assignment-store')); ?>";
...
<?php /**PATH E:\xampp\htdocs\jatrikoi-laravel-and-vue\resources\views//Assignment/create.blade.php ENDPATH**/ ?>