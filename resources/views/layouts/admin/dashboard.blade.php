...
<head>
    ...
    {{--    <script type="text/javascript" src="{{asset('assets/plugins/DataTables/DataTables/datatables.min.js')}}"></script>--}}
...
<div class="d-flex flex-column flex-root">
    ...
    <div class="d-flex flex-column flex-row-fluid " id="kt_wrapper">
        @include('.fliter.fliter')
    </div>
</div>
@include('.layouts.admin.quick-user')
@include('.layouts.admin.scroll-top')
