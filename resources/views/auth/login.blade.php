            ...
            <div class="login-aside d-flex flex-column flex-row-auto" style="background-color: #F2C98A;">
                <div class="d-flex flex-column-auto flex-column pt-lg-40 pt-15">
                    <a href="#" class="text-center mb-10">
                        <img src="{{asset('img/shuttle-logo.png')}}" class="max-h-70px" alt="" />
                    </a>
            ...
            <div class="login-content flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
                <div class="d-flex flex-column-fluid flex-center">
                    <div class="login-form login-signin">
                        <form class="form" method="POST" action="{{ route('login') }}" novalidate="novalidate" id="">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" value="{{ old('email') }}" type="text" name="email" autocomplete="off" />
                            </div>
                            <div class="form-group">
                                ...
                                <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" value="{{ old('password') }}" name="password" autocomplete="off" />
                            </div>
                            <div class="pb-lg-0 pb-5">
                                <button type="submit" id="" class="btn btn-primary font-weight-bolder font-size-h6 px-8 py-4 my-3 mr-3">Login</button>
                                <a type="button" href="{{ route('register') }}" class="btn btn-light-info font-weight-bolder px-8 py-4 my-3 font-size-lg"><span class="svg-icon svg-icon-md"></span>Register</a>
                            </div>
